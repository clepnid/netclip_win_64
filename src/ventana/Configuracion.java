...
public class Configuracion implements Serializable {
	...
	public String nombre, carpeta, serial, rutaGuardadoHttp, idioma, licencia, codigoApp;
	...
	public static Boolean controlarExistencia() {
		...
		try {
			...
			if (configDeserializada.codigoApp==null) {
				configDeserializada.codigoApp = generateRandomStrings(10);
			}
