...
public class Http {
	...
	public Http() {
		...
		//si la ruta del fichero de inicializacion no es correcta no se podrá realizar esta acción
		//si no se ha cargado la configuracion del menu no se podrá realizar esta acción
